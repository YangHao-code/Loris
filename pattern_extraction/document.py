"""
pattern_extraction/document.py
--------------------------------
...
class Document:
    ...
    lbl : Set[str]
        Possibly soft label set from the label universe Λ.
        Hard labels are the special case where ``|lbl| == 1``.
        Defaults to an empty set (unlabelled document).
    mtd : str
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Document(ttl={self.ttl!r}, lbl={self.lbl!r}, "
            f"cnt={preview!r})"
        )
